...
```bash
100-bagger-stock-screener$ sam build --use-container
```
...
```bash
100-bagger-stock-screener$ sam logs -n StockCheckerFunction --stack-name 100-bagger-stock-screener --tail
```
...
```bash
100-bagger-stock-screener$ pip install -r tests/requirements.txt --user
# unit test
100-bagger-stock-screener$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
100-bagger-stock-screener$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
aws cloudformation delete-stack --stack-name 100-bagger-stock-screener
```
